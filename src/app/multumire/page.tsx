...
function MultumireContent() {
  ...
  return (
    <div style={{ background: "#1A1814", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <main className="flex flex-1 items-center justify-center px-4 sm:px-6 py-20">
        <div className="mx-auto max-w-xl text-center">
          ...
          >
            {firstName ? (
              <>
                Bine ai venit,{" "}
                <em style={{ color: "#B8892A", fontStyle: "italic" }}>{firstName}.</em>
              </>
            ) : (
              <>
                Ești înscris/ă.{" "}
          ...
          >
            Înscrierea ta a fost confirmată. Verifică-ți emailul — vei primi în câteva minute detaliile webinarului: data, ora și linkul de acces.
          </p>
          ...
          <p
            ...
            style={{ fontFamily: "var(--font-jost), sans-serif", color: "#9A8F7A", fontWeight: 300 }}
          >
            Până atunci, te invit să intri în grupul nostru de WhatsApp dedicat acestui eveniment. Acolo vei găsi comunitatea de oameni care parcurg același drum — și unde vei primi resurse și remindere înainte de webinar.
          </p>

          {/* WhatsApp button */}
          <a
            href="https://chat.whatsapp.com/FszxsoozHsZADyx5YaDSCa"
            target="_blank"
